...
<HoverCard openDelay={0.1} closeDelay={0}>
  <HoverCardTrigger>Resources</HoverCardTrigger>
  <HoverCardContent className='w-100' align='start'>
    <div className='flex justify-start gap-4 w-[350px] ml-2'>
      <div> 
      ...
      <div >
        <div className='text-slate-500 text-sm w-40 py-2'> Premium Features</div>
        <div className='flex items-center gap-2 py-2'> <ImageIcon className='h-4 w-4 text-slate-700' /> <span className='text-sm'>Billing</span> </div>
        <div className='flex items-center gap-2 py-2'> <Settings className='h-4 w-4 text-slate-700' /> <span className='text-sm'>Billing</span> </div>
        <div className='flex items-center gap-2 py-2'> <Mail className='h-4 w-4 text-slate-700' /> <span className='text-sm'>Billing</span> </div>
        <div className='flex items-center gap-2 py-2'> <MessageCircle className='h-4 w-4 text-slate-700' /> <span className='text-sm'>Billing</span> </div>
        <div className='flex items-center gap-2 py-2'> <CreditCard className='h-4 w-4 text-slate-700' /> <span className='text-sm'>Billing</span> </div>
      </div>
    </div>
  </HoverCardContent>
</HoverCard>
